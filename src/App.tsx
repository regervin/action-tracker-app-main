...
import { PlusCircle, Trash2, Edit3, Save, CalendarDays, User, Building, Printer, FileText } from 'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 pb-3 border-b">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded-md shadow-md hover:shadow-lg transition duration-150 flex items-center"
                disabled={actions.length === 0 || isExporting}
              >
                <FileText size={20} className="mr-2" /> {isExporting ? 'Exporting...' : 'Export PDF'}
              </button>
              <button
                onClick={handlePrint}
                className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2 px-4 rounded-md shadow-md hover:shadow-lg transition duration-150 flex items-center"
